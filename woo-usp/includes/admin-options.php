		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr>
		            ...
		            <td colspan="2"><input name="wcusp_settings[wcusp_icon_color]" id="wcusp_icon_color" type="text" class="my-input-class" value="<?php if ( isset( $wcusp_options['wcusp_icon_color'] ) ) echo $wcusp_options['wcusp_icon_color']; ?>" >
